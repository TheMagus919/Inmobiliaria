...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2024 a las 01:06:19
...
INSERT INTO `contratos` (`idContrato`, `idInquilino`, `idInmueble`, `fechaDesde`, `fechaHasta`, `cancelado`) VALUES
(1, 4, 2, '2024-05-01', '2024-05-03', 0),
(3, 3, 5, '2024-06-14', '2024-06-30', 1),
(10, 1, 2, '2024-06-11', '2024-06-14', 0),
(11, 1, 2, '2024-06-15', '2024-06-16', 0),
(14, 1, 2, '2024-06-17', '2024-07-16', 0);
...
(6, 1, 4, 'comercial', 'Los Molles 203', 'local', 34152413, 12341441, 2000000, 1);
...
(1, 'Pedro', 'Fonseca', '42675234', 'pedrof@gmail.com', '2556432455'),
(3, 'Mario', 'Kempes', '42675237', 'marianokempes@gmail.com', '2665142425'),
(4, 'Sofia', 'Soule', '41241432', 'soule@gmail.com', '2664564523');
...
(3, 1, '2023-09-21', 2, 3),
(4, 13, '2024-06-01', 24000, 1),
(5, 14, '2024-06-16', 50000, 1),
(6, 15, '2024-07-04', 80000, 1);
...
(1, 'Jorge Agustin', 'Barroso', '42278146', '2665258343', 'agustinbarroso919@gmail.com'),
